window.onload = () => {
  ...
  document
    .getElementsByClassName("nav-btn")[0]
    .addEventListener("click", () => {
      window.location.href = "../cardapio/"
    })
  document
    .getElementsByClassName("nav-btn")[1]
    .addEventListener("click", () => {
  ...
  fetch("../assets/database/produtos.json")
    ...
    .then((jsonProdutos) => {
      const produtosList =
        document.getElementsByClassName("container-produtos")[0]
      ...
      for (
        let i = 0;
        i < document.getElementsByClassName("produto").length;
        i++
      ) {
        document
          ...
          [i].addEventListener("click", () => {
            localStorage.setItem(
              "codigo-produto",
              document.getElementsByClassName("produto")[i].id
            )
